...
struct login_info{
    ...
    login_info(std::string nome, std::string cognome, std::string email_tel, std::string password, unsigned int giorno, unsigned int mese,unsigned int anno, bool genere){
